...
class MyTaskDataProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples_train_dev(os.path.join(data_dir, MyTaskDataProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples_train_dev(os.path.join(data_dir, MyTaskDataProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples_unlabelled(os.path.join(data_dir, MyTaskDataProcessor.UNLABELED_FILE_NAME), "unlabeled")
        #return self.get_train_examples(data_dir)
    ...
    def _create_examples_train_dev(self, path, set_type, max_examples=-1, skip_first=0):
    ...
    def _create_examples_unlabelled(self, path, set_type, max_examples=1, skip_first=0):
